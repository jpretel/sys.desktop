 ...
 * <BR>
 * JScrollableDesktopPane builds upon JDesktopPane and JScrollPane to provide a
 * complete virtual desktop environment that enables easy access to internal
 * frames that may have been positioned offscreen. This access is made possible
 * via real-time creation and manipulation of the desktop preferred size. <BR>
 * <BR>
 ...
 * are added beyond the width of the container. <BR>
 * <BR>
 ...
 * <code>Tile</code> positions and resizes the internal frames to fill up all
 * available screen real estate, with no single frame overlapping any other. <BR>
 * <BR>
 ...
 * scrollable desktop. A JMenuBar object may also be registered by passing it as
 * a constructor parameter to the JScrollableDesktopPane. <BR>
 * <BR>
 * An example usage follows: <BR>
 * <BR>
 * <code><pre>
 ...
 * </pre></code>
 *
 * JScrollableDesktopPane has been tested under Java 2 JDK versions 1.3.1-b24 on
 * Linux and jdk1.3.0_02 on Windows and Intel Solaris.
 *
...
public class JScrollableDesktopPane extends JPanel implements DesktopConstants {
	...
	/**
	 * creates the JScrollableDesktopPane object, registers a menubar, and
	 * assigns a default internal frame icon.
	 *
	 * @param mb
	 *            the menubar with which to register the scrollable desktop
	 * @param defaultFrameIcon
	 *            the default icon to use within the title bar of internal
	 *            frames.
	 */
	...
	/**
	 * adds an internal frame to the scrollable desktop. <BR>
	 * <BR>
	...
	public JInternalFrame add(String title, ImageIcon icon,
		...
		return desktopMediator
				.add(title, icon, frameContents, isClosable, x, y);
	...
	/**
	 * registers a menubar to which the "Window" menu may be applied. <BR>
	 * <BR>
	 * Propogates the call to DesktopMediator.
	 *
	 * @param mb
	...
	/**
	 * returns the internal frame currently selected upon the virtual desktop. <BR>
	 * <BR>
	 * Propogates the call to DesktopMediator.
	 *
	...
	/**
	 * selects the specified internal frame upon the virtual desktop. <BR>
	 * <BR>
	 * Propogates the call to DesktopMediator.
	 *
	 * @param f
	 ...
	 * the user when the contents of an inactive internal frame have changed. <BR>
	 * <BR>
	 * Propogates the call to DesktopMediator.
	 *
	 * @param f
